...
![sitemap diagram of Clare's Portfolio](./docs/Portfolio_sitemap.jpg)

![sitemap xml of Clare's Portfolio](./docs/xml-sitemap.jpg)
...
![Making HTML structures](./docs/12-4-SS.jpg)

After creating basic HTML structures, these are what the pages looked like.
![after completing basic HTML of Home page (Mobile)](./docs/12-04-SSHome2.jpg)

![after completing basic HTML of Home page (Tablet)](./docs/12-04-SSHome3.jpg)

![after completing basic HTML of Home page (Desktop)](./docs/12-4-SSHome.jpg)
...
![after completing basic HTML of About page (Tablet)](./docs/12-04-SSAbout.jpg)

![after completing basic HTML of Project page (Tablet)](./docs/12-04-SSProject.jpg)

![after completing basic HTML of Blog page (Mobile)](./docs/12-04-SSBlogs.jpg)
...
![after completing basic HTML of blog post (Tablet)](./docs/12-04-SSBlog2.jpg)
...
![after completing basic CSS of Home page (Mobile)](./docs/13-04-SSHome.jpg)

![after completing basic CSS of Home page (Tablet)](./docs/13-04-SSHome3.jpg)

![after completing basic CSS of Home page (Desktop)](./docs/13-04-SSHome2.jpg)
...
##### About me page
![after completing basic CSS of About Me page (Mobile)](./docs/14-04-SSAbout1.jpg)

![after completing basic CSS of About Me page (Tablet)](./docs/14-04-SSAbout2.png)

![after completing basic CSS of About Me page (Desktop)](./docs/14-04-SSAbout3.jpg)
...
![after completing basic CSS of Blogs page (Desktop)](./docs/14-04-SSBlogs1.jpg)

##### Projects Page  

![after completing basic CSS of projects page (Mobile)](./docs/14-04-SSProjects1.jpg)

![after completing basic CSS of projects page (Tablet)](./docs/14-04-SSProjects2.jpg)

![after completing basic CSS of projects page (Desktop)](./docs/14-04-SSPeojects3.jpg)  
...
![after completing basic CSS of contacts page (Desktop)](./docs/16-04-SSContact.jpg)
...
![creating keyframes in variable.scss](./docs/15-04-SSKeyframes.jpg)
...
![adding accessibility features to footer](./docs/16-04-SSFooter.jpg)
...
![making changes to footer style in desktop view](./docs/19-04-SSnewFooter.jpg)
...
![adding input section for your name in contact form](./docs/21-04SScontact.jpg)
...
![view of formspree captcha users will see after email submission](./docs/21-04-SSformspree.jpg)
