...
# Purpose  
This portfolio paga was created to showcase my coding skills with a particular focus on HTML and CSS/SCSS. 
...
I began working on my project by firstly creating a Trello Board for things that I needed to do. I created large-scale cards first with color coded tags. Tags would indicate whether this task is a preparation, coding, html, styling or documenting task. This enabled me to organise my tasks into order that I would prioritise for the day, and overall helped me avoid confusion.
